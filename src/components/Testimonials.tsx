...
const reviews = [
  ...
  },
  {
    ...
    text:
      "The smart lighting alone is unreal. Cooking late at night feels cinematic — and the team handled every tiny detail without a single nudge.",
    rating: 5,
  },
  {
    name: "Sophia Khan",
  ...
  },
  {
    ...
    text:
      "We trusted Lumen with our flagship's open kitchen. The result is a stage — guests literally stop to watch the chefs work.",
    rating: 5,
  },
];
