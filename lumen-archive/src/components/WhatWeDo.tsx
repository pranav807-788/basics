...
const services = [
  {
    ...
    desc: "Tailored cabinetry, drawers and finishes ΓÇö engineered to the millimetre for your space.",
    icon: ModuleIcon,
  },
  {
  ...
  {
    title: "Installation",
    desc: "White-glove install by trained crews ΓÇö site protection, calibration, and a final walkthrough.",
    icon: InstallIcon,
  },
  {
    title: "Custom Design",
    desc: "Bespoke kitchens drawn to a single brief ΓÇö from millwork details to artisanal hardware.",
    icon: CustomIcon,
  },
];
  ...
  return (
    <div className="flex flex-col items-start gap-8 md:flex-row md:items-end md:justify-between">
      ...
      >
        ...
        ΓÇö never bolted on, always composed.
      </motion.p>
    </div>
  );
}
